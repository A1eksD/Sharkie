...
const loadLevel  = new Level(
        ...
        [ // alle 720px wird eine neuer Hinterund gerendert
            ...
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', -720*4, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L2.png', -720*3, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', -720*2, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L2.png', -720, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', 0, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L2.png', 720, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', 720*2, 0,1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L2.png', 720*3, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', 720*4, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L2.png', 720*5, 0, 1.8),
            new BackgroundObjext('img/3.Background/Layers/3.Fondo_1/L1.png', 720*6, 0, 1.8),

            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', -720*4, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L2.png', -720*3, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', -720*2, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L2.png', -720, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', 0, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L2.png', 720, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', 720*2, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L2.png', 720*3, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', 720*4, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L2.png', 720*5, 0, 0.8),
            new BackgroundObjext('img/3.Background/Layers/4.Fondo_2/L1.png', 720*6, 0, 0.8),
